      ...
      <div class="post-loop-grid">
        <div class="container">
          <div class="text-center">
            <h6 class="f-18 color-text-mutted text-uppercase">Privacy Policy</h6>
            <h2 class="section-title mb-10 wow animate__animated animate__fadeInUp ">Privacy Policy</h2>
          </div>
          <div class="row mt-40">
            <div class="col-lg-12">
              <p class="font-sm color-text-paragraph wow animate__animated animate__fadeInUp">
                {!! $get_term_conditions->company_privacy_policy_description !!}
              </p>
            </div>
          </div>
        </div>
